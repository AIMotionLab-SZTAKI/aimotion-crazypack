...
def read_optitrack(filename = './csv/optitrack.csv'):
    ...
    for data in position_dictionary:
        if data[0:2] == "cf" or data[0:2] == "bu":
            landingzone_positions[data] = position_dictionary[data]
    
    
    
    return obstacle_positions, vehicle_positions, landingzone_positions
