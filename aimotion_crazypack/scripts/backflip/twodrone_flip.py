...
if __name__ == "__main__":
    ...
    # allcfs.crazyflies[1].goTo(np.array([x+0.8, y+0.6, initHeight+0.2]), 0, 2)
    # allcfs.crazyflies[1].setParam('stabilizer/controller', 4)  # flip controller
    ...
    cf1.goTo(np.array([-1, y-0.6, 0.6]), 0, 2)
