...
def read_log(filename='/media/crazyfly/UNTITLED/log52'):
...
# res1 = read_log('/media/crazyfly/UNTITLED/log48')
res1 = read_log()
plt.figure()
plt.plot(res1["z"])
plt.show()
# res2 = read_log('log_with_gp_2')
...
#
# with open('log_with_gp_2.csv','w') as ofile:
